...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Trace_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Trace_t qt_meta_stringdata_Trace = {
    {
QT_MOC_LITERAL(0, 0, 5) // "Trace"
...
QT_INIT_METAOBJECT const QMetaObject Trace::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Trace.data,
    qt_meta_data_Trace,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Trace::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Trace.stringdata0))
